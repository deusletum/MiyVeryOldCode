...
{
    var ForAppending = 8;
    var oEnv, oFSO, oStream, oDate, sDate;
    var bOverWrite = true;
...
function Usage()
{
    ...
    WScript.Echo("/MSILOG: - Specifies file name and path for the install log file"
...
function Main()
{
    ...
    var sBuild, sMOMXBuild, bUseRosettaBuild, bUseMOMXBuild;
        ...
        for (;!aArgs.atEnd();aArgs.moveNext())
        {
            ...
            switch (aSplit[0].toUpperCase())
            {
                ...
                case "/AUTOSTART":
                    ...
                    {
                        WriteLog("VAR_ABORT - " + sSplit + " is not a valid value for /AUTOSTART:", sLog, iUserInputError);
                    }
                    break;
                case "/VDIRECTORY":
                    ...
                    {
                        WriteLog("VAR_ABORT - " + sSplit + " is not a valid value for /VDIRECTORY:", sLog, iUserInputError);
                    }
                    break;
                case "/VAPP":
                    ...
                    {
                        WriteLog("VAR_ABORT - " + sSplit + " is not a valid value for /VAPP:", sLog, iUserInputError);
                    }
                    break;
                case "/DBSERVER":
                    ...
                    {
                        WriteLog("VAR_ABORT - " + sSplit + " is not a valid value for /DBSERVER:", sLog, iUserInputError);
                    }
                    break;
                case "/DBNAME":
                    ...
                    {
                        WriteLog("VAR_ABORT - " + sSplit + " is not a valid value for /DBNAME:", sLog, iUserInputError);
                    }
                    break;
                case "/PERPROCESSOR":
                    ...
                    {
                        WriteLog("VAR_ABORT - " + sSplit + " is not a valid value for /PERPROCESSOR:", sLog, iUserInputError);
                    }
                    break;
                case "/PERSEAT":
                    sResult = sSplit.match(regexNumbers);
                    ...
                    {
                        WriteLog("VAR_ABORT - " + sSplit + " is not a valid value for /PERSEAT:", sLog, iUserInputError);
                    }
                    break;
                case "/MSILOG":
                    ...
                    {
                        WriteLog("VAR_ABORT - " + sSplit + " is not a valid value for /MSILOG:", sLog, iUserInputError);
                    }
                    break;
                default:
                    WriteLog("VAR_ABORT - " + aSplit[0] + " is not a valid switch", sLog, iUserInputError);
                    break;
            }               
        }
    }
    ...
    {
        WriteLog("VAR_ABORT - /BUILD: and /MOMXBUILD: cannot be used together, you must use one or the other", sLog, iUserInputError);
    }
    ...
    if((sPERPROCESSOR) && (sPERSEAT))
    {
        WriteLog("VAR_ABORT - both /PERPROCESSOR: and /PERSEAT: switches where specified", sLog, iUserInputError);
    }
    ...
    if(bUseMOMXBuild)
    {
        ...
        if(oFSO.FileExists(sRosettaINIFile))
        {
            try
            {
                ...
                sBuild = oStream.ReadAll();
                oStream.Close();
            }
            catch(e)
            {
                WriteLog("VAR_ABORT - Inst_Rosetta.js was unable to open file " + sRosettaINIFile, sLog, iUnableOpenFile);
            }
        }
        else
        {
