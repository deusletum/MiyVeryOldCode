...
# 
#
# Summary   : parses test results into xml
#
# Usage     : momx.pl testype
#
# History   : 5/1/2003 - Dean Gjedde - Created
# ----------------------------------------------------------------------
use XML::Parser;
use URI::Escape;
use strict;
...
if ((@ARGV[0] ne "bvt") && (@ARGV[0] ne "smoke") && (@ARGV[0] ne "func")) {
	print "Invalid Results type - please make either 'bvt', 'smoke' or 'func' \n";
	exit 1;
}
...
$p1 -> parsefile('\\\\smdata\\Data\\Infra\\XML\\Build\\testareas_MOMX.xml');
