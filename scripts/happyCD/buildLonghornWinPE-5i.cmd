...
set XP_PATH="c:\xpsp2"
set WINPE_TOOLSPATH=c:\bin\opk\winpe
set WINPE_SERVER=d:\
set WINPE_ROOT=%1
set WINPE_TOOLS=%2
set ISO_PATH=%3
...
REM ***************************************************************************
if exist %WINPE_TOOLSPATH% (rd %WINPE_ROOT% /S /Q)
md %WINPE_ROOT%
...
REM ***************************************************************************
xcopy %WINPE_SERVER%\opk\boot %WINPE_ROOT% /e /H /R /Y
xcopy %WINPE_SERVER% %WINPE_TOOLS% /e /H /R /Y
...
REM ***************************************************************************
call %WINPE_TOOLS%\oscdimg.exe -n -b%WINPE_TOOLS%\etfsboot.com %WINPE_ROOT% %ISO_PATH%\HappyCD-5i.iso
